...
Confirms `models/FIRSTACCOUNT69-auto-map-test/model.py` exfiltrates env/host data to `127.0.0.1:8080/log` on plain `import model` - no class instantiation needed.
